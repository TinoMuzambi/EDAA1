...
# Find minimum mark
min.mark.1st.year <- min(pass.a12.pass.b1$num.grade.x, na.rm = TRUE)
cat("Minimum suggested mark from 1st year courses so that the student is able to pass B1:", min.mark.1st.year, "%")
```
...
# Find minimum mark.
min_mark.b1 <- pass.b1.b2.data %>%
  filter(course == "B1") %>%
  summarise(min.mark = min(num.grade, na.rm = TRUE))
cat("Minimum suggested mark from B1 so that the student is able to pass B2:", min_mark.b1$min.mark, "%")
```
