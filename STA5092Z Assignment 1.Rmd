...
merged.grades <- merge(a1.a2, b1.b2, by = "id", suffixes = c(".first", ".second"))

# Calculate the correlation
correlation.first.second <- cor(merged.grades$num.grade.first, merged.grades$num.grade.second, use = "pairwise.complete.obs")
cat("Correlation between the grades of 1st and 2nd year courses:", round(correlation, 2))
```
